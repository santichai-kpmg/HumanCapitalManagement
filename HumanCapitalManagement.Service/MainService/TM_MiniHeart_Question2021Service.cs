...
{
    public class TM_MiniHeart_Question2021Service : ServiceBase<TM_MiniHeart_Question2021>
    {
        public TM_MiniHeart_Question2021Service(IRepository<TM_MiniHeart_Question2021> repo) : base(repo)
        {
            //
        }
        public TM_MiniHeart_Question2021 Find(int id)
        {
            return Query().SingleOrDefault(s => s.Id == id && s.Active_Status == "Y");
        }
     
        public IEnumerable<TM_MiniHeart_Question2021> GetDataForSelect()
        {
            var sQuery = Query().Where(w => w.Active_Status == "Y");
            return sQuery.ToList();
        }

        public IEnumerable<TM_MiniHeart_Question2021> GetDataMainActive()
        {
        ...
        public int CreateNew(ref TM_MiniHeart_Question2021 s)
        {
            //s.Id = SelectMax();
        ...
        public int CreateNewOrUpdate(TM_MiniHeart_Question2021 s)
        {
            var sResult = 0;
        ...
        public int AdminUpdate(TM_MiniHeart_Question2021 s)
        {
            var sResult = 0;
