...
{
    public class TM_MiniHeart_PeroidService : ServiceBase<TM_MiniHeart_Peroid>
    {
        public TM_MiniHeart_PeroidService(IRepository<TM_MiniHeart_Peroid> repo) : base(repo)
        {
            //
        }
        public TM_MiniHeart_Peroid Find(int id)
        {
            return Query().SingleOrDefault(s => s.Id == id && s.Active_Status == "Y");
        }
     
        public IEnumerable<TM_MiniHeart_Peroid> GetDataForSelect()
        {
        ...
        public IEnumerable<TM_MiniHeart_Peroid> GetDataForSelectAll()
        {
        ...
        public int CreateNew(ref TM_MiniHeart_Peroid s)
        {
            //s.Id = SelectMax();
        ...
        public int CreateNewOrUpdate(TM_MiniHeart_Peroid s)
        {
            var sResult = 0;
        ...
        public int AdminUpdate(TM_MiniHeart_Peroid s)
        {
            var sResult = 0;
