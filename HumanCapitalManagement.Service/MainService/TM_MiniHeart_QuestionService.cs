...
{
    public class TM_MiniHeart_QuestionService : ServiceBase<TM_MiniHeart_Question>
    {
        public TM_MiniHeart_QuestionService(IRepository<TM_MiniHeart_Question> repo) : base(repo)
        {
            //
        }
        public TM_MiniHeart_Question Find(int id)
        {
            return Query().SingleOrDefault(s => s.Id == id && s.Active_Status == "Y");
        }
     
        public IEnumerable<TM_MiniHeart_Question> GetDataForSelect()
        {
            var sQuery = Query().Where(w => w.Active_Status == "Y");
            return sQuery.ToList();
        }

        public IEnumerable<TM_MiniHeart_Question> GetDataMainActive()
        {
        ...
        public int CreateNew(ref TM_MiniHeart_Question s)
        {
            //s.Id = SelectMax();
        ...
        public int CreateNewOrUpdate(TM_MiniHeart_Question s)
        {
            var sResult = 0;
        ...
        public int AdminUpdate(TM_MiniHeart_Question s)
        {
            var sResult = 0;
