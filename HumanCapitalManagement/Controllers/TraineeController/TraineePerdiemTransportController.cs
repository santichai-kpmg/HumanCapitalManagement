...
{
    public class TraineePerdiemTransportController : Controller
    {
        #region
        // GET: TraineePayMent
        ...
        public TraineePerdiemTransportController(TM_PR_Candidate_MappingService TM_PR_Candidate_MappingService
        ...
        public ActionResult TraineePerdiemTransportApprove()
        {
            return View();
        }
        ...
        public List<vPerdiem_Transport> bindlist(string approve_user, string traineename, string traineeid)
        {
            ...
            if (_getList != null)
                foreach (var a in _getList)
                {
                    ...
                    sublst.daterange = a.trainee_create_date.Value.ToString("dd MMM yyyy");
        ...
        public ActionResult SavePerdiem_Transport(vPerdiem_Transport ItemData, string type,string remark)
        {
            ...
            if (ItemData != null)
            {
                ...
                setdata.review_user = CGlobal.UserInfo.EmployeeNo;
                setdata.review_date = DateTime.Now;
                setdata.paid_user = CGlobal.UserInfo.EmployeeNo;
                setdata.paid_date = DateTime.Now;
