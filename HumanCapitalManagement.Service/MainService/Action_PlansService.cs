...
{
    public class Action_PlansService : ServiceBase<Action_Plans>
    {
        public Action_PlansService(IRepository<Action_Plans> repo) : base(repo)
        {
            //
        }
        public Action_Plans Find(int id)
        {
            return Query().SingleOrDefault(s => s.Id == id && s.Active_Status == "Y");
        }
     
        public IEnumerable<Action_Plans> GetDataForSelect()
        {
        ...
        public int CreateNew(ref Action_Plans s)
        {
            //s.Id = SelectMax();
        ...
        public int CreateNewOrUpdate(Action_Plans s)
        {
            var sResult = 0;
        ...
        public int AdminUpdate(Action_Plans s)
        {
            var sResult = 0;
