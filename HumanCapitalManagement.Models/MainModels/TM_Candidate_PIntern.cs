...
{
    public class TM_Candidate_PIntern
    {
        ...
        public virtual ICollection<TM_Candidate_PIntern_Answer> TM_Candidate_PIntern_Answer { get; set; }
        public virtual ICollection<TM_Candidate_PIntern_Approv> TM_Candidate_PIntern_Approv { get; set; }
