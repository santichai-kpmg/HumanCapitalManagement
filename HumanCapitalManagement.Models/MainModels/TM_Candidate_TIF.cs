...
namespace HumanCapitalManagement.Models.MainModels
{
    public class TM_Candidate_TIF
    {
        ...
        public virtual TM_TIF_Status TM_TIF_Status { get; set; }
        [Required]
        public virtual TM_PR_Candidate_Mapping TM_PR_Candidate_Mapping { get; set; }
        public virtual ICollection<TM_Candidate_TIF_Answer> TM_Candidate_TIF_Answer { get; set; }
        public virtual ICollection<TM_Candidate_TIF_Approv> TM_Candidate_TIF_Approv { get; set; }
