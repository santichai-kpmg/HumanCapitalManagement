...
{
    public class Probation_DetailService : ServiceBase<Probation_Details>
    {
        public Probation_DetailService(IRepository<Probation_Details> repo) : base(repo)
        {
            //
        }
        public Probation_Details Find(int id)
        {
            return Query().SingleOrDefault(s => s.Id == id && s.Active_Status == "Y");
        }
     
        public IEnumerable<Probation_Details> GetDataForSelect()
        {
        ...
        public int CreateNew(ref Probation_Details s)
        {
            //s.Id = SelectMax();
        ...
        public int CreateNewOrUpdate(Probation_Details s)
        {
            var sResult = 0;
        ...
        public int AdminUpdate(Probation_Details s)
        {
            var sResult = 0;
