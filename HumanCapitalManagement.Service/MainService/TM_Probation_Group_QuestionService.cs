...
{
    public class TM_Probation_Group_QuestionService : ServiceBase<TM_Probation_Group_Question>
    {
        public TM_Probation_Group_QuestionService(IRepository<TM_Probation_Group_Question> repo) : base(repo)
        {
            //
        }
        public TM_Probation_Group_Question Find(int id)
        {
            return Query().SingleOrDefault(s => s.Id == id );
        }

        public IEnumerable<TM_Probation_Group_Question> GetDataAllStatus()
        {
            var sQuery = Query();
            return sQuery.ToList();
        }
        public IEnumerable<TM_Probation_Group_Question> GetDataForSelect()
        {
        ...
        public int CreateNew(ref TM_Probation_Group_Question s)
        {
            //s.Id = SelectMax();
        ...
        public int CreateNewOrUpdate(TM_Probation_Group_Question s)
        {
            var sResult = 0;
        ...
        public int Update(TM_Probation_Group_Question s)
        {
            var sResult = 0;
            var _getData = Query().Where(w => w.Id == s.Id).FirstOrDefault();
            if (_getData != null)
        ...
        public int AdminUpdate(TM_Probation_Group_Question s)
        {
            var sResult = 0;
        ...
        public int UpdateInactive(TM_Probation_Group_Question s)
        {
            var sResult = 0;
