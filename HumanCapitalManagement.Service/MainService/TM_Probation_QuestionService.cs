...
{
    public class TM_Probation_QuestionService : ServiceBase<TM_Probation_Question>
    {
        public TM_Probation_QuestionService(IRepository<TM_Probation_Question> repo) : base(repo)
        {
            //
        }
        public TM_Probation_Question Find(int id)
        {
            return Query().SingleOrDefault(s => s.Id == id && s.Active_Status == "Y");
        }
     
        public IEnumerable<TM_Probation_Question> GetDataForSelect()
        {
        ...
        public int CreateNew(ref TM_Probation_Question s)
        {
            //s.Id = SelectMax();
        ...
        public int CreateNewOrUpdate(TM_Probation_Question s)
        {
            var sResult = 0;
        ...
        public int AdminUpdate(TM_Probation_Question s)
        {
            var sResult = 0;
