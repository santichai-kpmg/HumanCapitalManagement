...
namespace HumanCapitalManagement.ViewModel.NMNVM
{
    ...
    public class vNMNAdmin : CSearchNMNAdmin
    {
        public List<vNMNAdmin_obj> lstData { get; set; }
    }

    public class vNMNAdmin_Return : CResutlWebMethod
    {
        public List<vNMNAdmin_obj> lstData { get; set; }
    ...
    public class vAddEvaluationPlan_Return : CResutlWebMethod
    {
        ...
        public List<lstDataSelect> lstsponsering { get; set; }
    }
    public class vNMNAdmin_obj_save
    {
        public int Id { get; set; }
        public string IdEncrypt { get; set; }
    ...
    public class vPartnerKPIs_obj
    {
        ...
        public string lstKpi { get; set; }
        public string lstApproval { get; set; }
        public string lstRating { get; set; }
        public string sponsering_id { get; set; }
    }
