...
{
    public class TM_MiniHeart_Group_Question2021Service : ServiceBase<TM_MiniHeart_Group_Question2021>
    {
        public TM_MiniHeart_Group_Question2021Service(IRepository<TM_MiniHeart_Group_Question2021> repo) : base(repo)
        {
            //
        }
        public TM_MiniHeart_Group_Question2021 Find(int id)
        {
            return Query().SingleOrDefault(s => s.Id == id );
        }

        public IEnumerable<TM_MiniHeart_Group_Question2021> GetDataAllStatus()
        {
            var sQuery = Query();
            return sQuery.ToList();
        }
        public IEnumerable<TM_MiniHeart_Group_Question2021> GetDataForSelect()
        {
        ...
        public int CreateNew(ref TM_MiniHeart_Group_Question2021 s)
        {
            //s.Id = SelectMax();
        ...
        public int CreateNewOrUpdate(TM_MiniHeart_Group_Question2021 s)
        {
            var sResult = 0;
        ...
        public int Update(TM_MiniHeart_Group_Question2021 s)
        {
            var sResult = 0;
            var _getData = Query().Where(w => w.Id == s.Id).FirstOrDefault();
            if (_getData != null)
        ...
        public int AdminUpdate(TM_MiniHeart_Group_Question2021 s)
        {
            var sResult = 0;
        ...
        public int UpdateInactive(TM_MiniHeart_Group_Question2021 s)
        {
            var sResult = 0;
