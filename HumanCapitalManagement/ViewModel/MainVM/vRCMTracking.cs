...
namespace HumanCapitalManagement.ViewModel.MainVM
{
    ...
    public class vRCMTracking : CSearchRCMTracking
    {

        public List<vSelect_PR> lstSubGroup { get; set; }
        public List<vSelect_PR> lstPosition { get; set; }
        public List<vRCMTracking_obj> lstData { get; set; }
    }

    public class vRCMTracking_Return : CResutlWebMethod
    {
        public List<vRCMTracking_obj> lstData { get; set; }
    }
    public class vRCMTracking_obj
    {
    ...
    public class vRCMTracking_obj_view
    {
        ...
        //approver
        public List<vRCMTracking_lst_approve> lstApprove { get; set; }
        //plan
        ...
        public List<vRCMTracking_lstData> lstCandidates { get; set; }

    }

    public class vRCMTracking_lstData
    {
    ...
    public class objRCMTracking_Return : CResutlWebMethod
    {

    }
    public class vRCMTracking_Approve_Permit
    {
        public string Edit { get; set; }
    ...
    public class vRCMTracking_lst_approve
    {
    ...
    public class vRCMTracking_popup_detail
    {
        public string IdEncrypt { get; set; }
