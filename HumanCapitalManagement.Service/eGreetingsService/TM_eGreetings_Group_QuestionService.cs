...
{
    public class TM_eGreetings_Group_QuestionService : ServiceBase<TM_eGreetings_Group_Question>
    {
        public TM_eGreetings_Group_QuestionService(IRepository<TM_eGreetings_Group_Question> repo) : base(repo)
        {
            //
        }
        public TM_eGreetings_Group_Question Find(int id)
        {
            return Query().SingleOrDefault(s => s.Id == id );
        }

        public IEnumerable<TM_eGreetings_Group_Question> GetDataAllStatus()
        {
            var sQuery = Query();
            return sQuery.ToList();
        }
        public IEnumerable<TM_eGreetings_Group_Question> GetDataForSelect()
        {
        ...
        public int CreateNew(ref TM_eGreetings_Group_Question s)
        {
            //s.Id = SelectMax();
        ...
        public int CreateNewOrUpdate(TM_eGreetings_Group_Question s)
        {
            var sResult = 0;
        ...
        public int Update(TM_eGreetings_Group_Question s)
        {
            var sResult = 0;
            var _getData = Query().Where(w => w.Id == s.Id).FirstOrDefault();
            if (_getData != null)
        ...
        public int AdminUpdate(TM_eGreetings_Group_Question s)
        {
            var sResult = 0;
        ...
        public int UpdateInactive(TM_eGreetings_Group_Question s)
        {
            var sResult = 0;
