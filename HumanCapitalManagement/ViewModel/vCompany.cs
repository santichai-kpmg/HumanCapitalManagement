...
namespace HumanCapitalManagement.ViewModel
{
    ...
    {
        public List<vCompany_obj> lstData { get; set; }
    }
    ...
    public class vCompany_obj_save
    {
        ...
        public string update_date { get; set; }
        public string update_user { get; set; }
        public List<vCompany_Approve_Permit> lstData { get; set; }

    }

    public class objCompany_Return : CResutlWebMethod
    {
        public List<vCompany_Approve_Permit> lstData { get; set; }

    }
    public class vCompany_Approve_Permit
    {
        public string Edit { get; set; }
    ...
    public class vCompanyApprover_obj_save
    {
        public string IdEncrypt { get; set; }
