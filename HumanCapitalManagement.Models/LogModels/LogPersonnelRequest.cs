...
namespace HumanCapitalManagement.Models.LogModels
{
    public class LogPersonnelRequest
    {
        [DatabaseGenerated(DatabaseGeneratedOption.Identity)]
        public int Id { get; set; }
        public int? PersonnelRequest_Id { get; set; }
        public int? seq { get; set; }
        public int? TM_Divisions_Id { get; set; }
        public int? TM_SubGroup_Id { get; set; }
        public int? TM_Employment_Request_Id { get; set; }
        public int? TM_Pool_Rank_Id { get; set; }
        public int? TM_Position_Id { get; set; }
        public int? TM_PR_Status_Id { get; set; }
        [StringLength(50)]
